...
final class OSLogLoggerTests : XCTestCase {
	...
	override class func setUp() {
		LoggingSystem.bootstrap{ _ in OSLogLogger(label: "com.xcode-actions.oslog-logger:Tests") }
	}
	...
	func testVisual1() {
		...
		logger.notice("with some metadata", metadata: ["pub.whats_wrong": #"Shit’s on "fire", yo!"#])
	...
	func testVisual3() {
		...
		logger.critical("YAM!\nhere is the second line\nand why not a third one", metadata: ["pub.with": ["metadata", "again"], "because": "42"])
	}
